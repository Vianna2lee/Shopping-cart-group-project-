...
from Currency_part import * #return list of exchange rate, chosen currency , total price in desie currency
from Account import *
import pyfiglet 
...
#choose time slot for delivery
print(time_slot())
choose_time_for_delivery()
...
if total_price>=10 and total_price<=1000:
   ...
   currency_exchange(chosen_currency,total_price,currency_dict()) #currency exchange
